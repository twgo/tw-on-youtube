    ...
    if data_format == 'wav'
      {
        ...
        'audio-format': 'wav',
        'audio-quality': 0,
        'output': 'public/download/wav/%(channel_id)s/%(channel_id)s%-%(playlist_id)s-%(id)s.%(ext)s',
    ...
    elsif data_format == 'mp4'
      {
        ...
        'output': 'public/download/mp4/%(channel_id)s/%(channel_id)s%-%(playlist_id)s-%(id)s.%(ext)s',
