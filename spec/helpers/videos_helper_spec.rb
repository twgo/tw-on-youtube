...
RSpec.describe VideosHelper, type: :helper do
  ...
  it 'return vtt' do
    FileUtils.mkdir_p('public/download/mp4/test_uid')
    File.open("public/download/mp4/test_uid/test.vtt", 'a') {|f| f.write("test vtt") }
    ...
    FileUtils.rm_rf(Dir.glob('public/download/mp4/test_uid/*'))
    FileUtils.rm_rf('public/download/mp4/test_uid/')
  end
end
